(function (window) {
  ...
  function discoveryAnswers(form) {
    ...
    var appointmentReason = { price:'comparison', upcoming_renewal:'renewal_increase', new_home_or_vehicle:'life_change', coverage_concern:'something_else', comparison:'comparison', nonrenewal_notice:'something_else', renewal_change:'renewal_increase', shopping_price:'comparison', buying_condo:'buying_home', coverage_review:'something_else' }[field(form, 'review_reason')] || '';
  ...
  function build(form) {
    ...
    var profile = {
      ...
      propertyType: field(form, 'property_type'),
      currentCarrier: field(form, 'current_carrier'),
      renewalTiming: field(form, 'renewal_timing'),
      autoVehicleCount: field(form, 'auto_vehicle_count'),
      fivSignalVersion: field(form, 'fiv_signal_version'),
