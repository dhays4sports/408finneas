(function (window, document) {
  ...
  function buildPayload(options) {
    ...
    var payload={
      ...
      journey_goal:clean(extra.journey_goal,40),review_track:clean(extra.review_track||profile.reviewTrack||track,40),review_reason:clean(extra.review_reason||profile.reviewReason,60),fiv_signal_version:clean(extra.fiv_signal_version||profile.fivSignalVersion,80),
    ...
    if(config.entry==='condo'){payload.property_type='condo';payload.current_carrier=clean(profile.currentCarrier,60);payload.renewal_timing=clean(profile.renewalTiming,40);payload.auto_vehicle_count=clean(profile.autoVehicleCount,20);payload.housing_context=clean(profile.housingContext,40)||'owner_occupied';}
