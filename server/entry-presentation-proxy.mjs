...
export async function entryAction(request,options={}){
  ...
  try{
    const upstream=await (options.fetch||fetch)(new URL(action,COVERAGEFIT_ENTRY_BASE),{method:'POST',redirect:'error',headers:{'Content-Type':'application/json',Origin:'https://coveragefit.com',Cookie:cookie(request)},body});
