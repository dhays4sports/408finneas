...
(function(window,document){
  ...
  if(form.dataset.appointmentFlow==='condo' && window.condoHoaReferral){
    config.questions[0].options.unshift(['hoa_coverage_question','I have questions about my HOA and condo coverage']);
    // Keep all established fields while putting condo use before optional household context.
    var condoUse=config.questions.pop();config.questions.splice(3,0,condoUse);
  }
