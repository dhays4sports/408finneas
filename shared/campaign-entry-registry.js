(function (root, factory) {
  ...
  var ENTRIES = Object.freeze({
    ...
    realtor_buyer_card: Object.freeze({
      ...
      copy: Object.freeze({ kicker: 'Buying a home', title: 'Need Coverage for Your Closing?', lead: 'Let’s organize the insurance side while your purchase keeps moving.', body: 'Share the property address, estimated closing date, and how you’ll use the home, then provide your contact details so Dylan can follow up.', startOnline: 'Start My Buyer Review' })
    }),
